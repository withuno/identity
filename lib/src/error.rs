...
{
    fn from(e: adi::Error) -> Self { Error::Shamir(e) }
}

impl From<djb::Error> for Error
{
    fn from(e: djb::Error) -> Self { Error::Curve25519(e) }
}

impl From<s39::Error> for Error
{
    fn from(e: s39::Error) -> Self { Error::S39(e) }
}

impl From<argon2::Error> for Error
{
    fn from(e: argon2::Error) -> Self { Error::Hash(format!("argon2 - {}", e)) }
}
